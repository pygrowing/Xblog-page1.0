...
function(t, e, r) {
	...
	function o(t, e) {
		...
		var i = f('<div class="wechat-qrcode"><h3>' + e.wechatQrcodeTitle + '</h3><div class="qrcode"></div><div class="help">' + e.wechatQrcodeHelper + "</div></div>"),
			n = d(i[0], "qrcode", "div");
	...
	var _ = Array.prototype.indexOf,
		...
		b = {
			...
			wechatQrcodeHelper: "<p>扫描二维码，分享此文章</p>",
